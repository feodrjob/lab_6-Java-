...
public class nameShakeTest {
    ...
    public void getNamesake1(){
        Assert.assertArrayEquals(namesake1.toArray(),getNamesakes(humans,human3).toArray());
    }

    @Test
    public void getNamesake2(){
        Assert.assertArrayEquals(namesake2.toArray(),getNamesakes(humans,human4).toArray());
    }
}
